...
export default function TermsModal({ isActive, onClose }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      <div className="relative w-[90%] max-w-2xl rounded-lg border border-[#fda963] bg-black p-6 shadow-xl">
        ...
        <p className="font-futura text-center text-[10px] text-white italic md:text-sm lg:text-base">{t('text.termsText')}</p>
      </div>
    </div>
  )
}
