    ...
    <div className="m-8 flex flex-col justify-center text-[#fda963]">
      ...
      <div className="flex justify-center">
        <p className="mt-10 w-[80%] text-justify">
          ...
          restless idea called <i>Pulse</i> a desire to create a tribute show so alive that its
      ...
      <div className="flex justify-center">
        <p className="mt-10 w-[80%] text-justify">
          ...
          <br /> I began searching for the voices that de fi ned womanhood—from the poetry of Jackie
          ...
          <br />
          <b>The Women Who Made Us seeks to revive that collective stage. #### The Collective</b>
          ...
          underestimated. I built an army of believers who recognized themselves in this mission. <br /><br />
          <i>The Women Who Made Us</i> is a love letter to the past and a blueprint for the future. It was
          born from longing, nostalgia, and an unshakable belief that none of us are here alone. <br /><br /> <b>We
          are here because of the women who made us.</b>
        </p>
      </div>
    </div>
  )
